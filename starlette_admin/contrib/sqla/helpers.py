...
USERS_STATUS_LIST = ["regularuser", "commiteruser", "admin"]
...
def matches_allowed_status(user_account_status: str, users_status_list: list) -> bool:
            """Return True if any status from user_account_status is in users_status_list."""
            return any(status in users_status_list for status in user_account_status.split("/"))