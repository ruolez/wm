...
class TextAreaField(StringField):
    ...
    identity1: Optional[str] = None
    identity2: Optional[str] = None
    identity3: Optional[str] = None
    identity4: Optional[str] = None
    identity5: Optional[str] = None
...
@dataclass
class IntegerField1(NumberField):
    ...
    select2: bool = False
    other_params_1: str = "testttt"
    other_params_2: str = "testttt"
    other_name: str = "db: Nick 1 Choose Category / Subcategoryeeeee"
    identity: Optional[str] = None
    identity1: Optional[str] = None
    identity2: Optional[str] = None
    identity3: Optional[str] = None
...
class FloatField2(StringField):
    ...
    identity4: Optional[str] = None
    identity5: Optional[str] = None
    class_: str = "field-float form-control test"
...
class EnumField1(StringField):
    ...
    form_template: str = "forms/enum2.html"
    display_template: str = "displays/displaysenum2.html"
...
@dataclass
class DateField_dig(DateTimeField):
    input_type: str = "date"
    class_: str = "field-date form-control"
    output_format: Optional[str] = None
    search_format: str = "MM-DD-YYYY"
    search_builder_type: str = "moment-LL"
    form_alt_format: Optional[str] = "F j, Y"
...
class FileField(BaseField):
    ...
    label_template: str = "forms/_label_upload.html"
