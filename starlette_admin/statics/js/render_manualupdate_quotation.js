...
const render = {
  ...
  col_1: function (data, type, full, meta) {
    ...
    */
    ...
    /*        <button type="submit" name="_update_quotation" class="btn btn-primary btn-block me-2">Update</button>
            <button type="submit" name="_return_quotation" class="btn btn-danger">Return</button>
    */


    /*<a href="${full._new_quotation_edit}?SourceDB=${ full.SourceDB }&BusinessName=${ full.BusinessName }
    &AccountNo=${ full.AccountNo }&ProductDescription=${ full.ProductDescription }&SKU=${ full.SKU }
    &QTY=${ full.QTY }&Price=${ full.Price }">
     <button type="button" class="btn btn-primary btn-block me-2" style="font-size: 12px;">
                                                Edit</button></a>*/
