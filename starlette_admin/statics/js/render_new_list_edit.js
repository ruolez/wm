$(function () {
  ...
  (function () {
    ...
    while (fringe.length > 0) {
      ...
      else if (field.name === "SourceDB") {
      }
      else if (field.name === "BusinessName") {
      }
      else if (field.name === "AccountNo") {
      }
  ...
  if (model.searchBuilder)
    buttons.push({
      ...
      config: {
        ...
        conditions: {
          bool: {
            false: noInputCondition("admin.conditions.false"),
            true: noInputCondition("admin.conditions.true"),
            null: noInputCondition("admin.conditions.empty"),
            "!null": noInputCondition("admin.conditions.notEmpty"),
          },
          default: {
            null: noInputCondition("admin.conditions.empty"),
            "!null": noInputCondition("admin.conditions.notEmpty"),
  ...
  var table = $("#dt").DataTable({
    dom: "r<'table-responsive't><'card-footer d-flex align-items-center'<'m-0'i>>",
    paging: true,
    lengthChange: true,
    searching: true,
    info: false,
